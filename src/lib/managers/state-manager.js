...
class StateManager {
  ...
  constructor(options = {}) {
    ...
    this.stateTransitions = {
      ...
      [this.states.INITIALIZED]: [this.states.SESSION_STARTED, this.states.INITIALIZED, this.states.ERROR],
      [this.states.SESSION_STARTED]: [this.states.TASK_IN_PROGRESS, this.states.SESSION_ENDED, this.states.ERROR],
      [this.states.TASK_IN_PROGRESS]: [this.states.FEEDBACK_COLLECTED, this.states.SESSION_ENDED, this.states.ERROR],
      [this.states.FEEDBACK_COLLECTED]: [this.states.TASK_IN_PROGRESS, this.states.SESSION_ENDED, this.states.ERROR],
